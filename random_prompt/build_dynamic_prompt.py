...
def build_dynamic_prompt(
    ...
    nonfictionallist = csv_to_list(
        csvfilename="nonfictional characters", antilist=antilist, skipheader=True, gender=gender
    )
    ...
    genderdescriptionlist = csv_to_list(
        csvfilename="genderdescription", antilist=antilist, skipheader=True, gender=gender
    )
    ...
    manwomanrelationlist = csv_to_list(
        csvfilename="manwomanrelations", antilist=antilist, skipheader=True, gender=gender
    )
    ...
    while compoundcounter < promptstocompound:
        ...
        if templatemode == True:
            ...
            templateprompts = [
                ...
                if (
                    (templateprompt[1] == targettemplateenvironment or targettemplateenvironment == "all")
                    and (templateprompt[2] == templateenvironmentsources or templateenvironmentsources == "all")
        ...
        if generatesubject == True:
            ...
            if mainchooser == "object":
                ...
                if givensubject == "":
                    ...
                    if hybridorswap == "swap":
                        if uncommon_dist(insanitylevel):
                            completeprompt += (
                                ":" + random.choice(objectwildcardlist) + ":" + str(random.randint(1, 5)) + "] "
                            )
                        else:
                            completeprompt += ":"
                            completeprompt += chosenobjectwildcard + " "
            ...
            if mainchooser == "humanoid":
                if givensubject == "":
                    ...
                    if subjectchooser == "fictional":
                        ...
                        if hybridorswap == "swap":
                            completeprompt += (
                                ":" + random.choice(hybridhumanlist) + ":" + str(random.randint(1, 5)) + "] "
                            )
                        hybridorswap = ""
            ...
            if (mainchooser == "humanoid" or mainchooser == "animal" or mainchooser == "object") and chance_roll(
                insanitylevel, subjectconceptsuffixchance
            ):
        ...
        if (
            subjectchooser
            in ["animal as human,", "human", "fictional", "non fictional", "humanoid", "manwomanrelation", "firstname"]
        ...
        if (
            subjectchooser
            in ["human", "job", "fictional", "non fictional", "humanoid", "manwomanrelation", "firstname"]
    ...
    while (
        ...
        or "-artistfantasy-" in completeprompt
        or "-artistpopular-" in completeprompt
        or "-artistromanticism-" in completeprompt
        or "-artistphotography-" in completeprompt
        ...
        for wildcard in allwildcardslistnohybrid:
            ...
            completeprompt = replacewildcard(
                completeprompt, insanitylevel, wildcard, attachedlist, False, advancedprompting
            )
        ...
        for wildcard in allwildcardslistwithhybrid:
            ...
            completeprompt = replacewildcard(
                completeprompt, insanitylevel, wildcard, attachedlist, True, advancedprompting
            )
    ...
    if insanitylevel != 0:
        ...
        while originalprompt == prompt and runs != maxamountofruns:
            for combination in combinations_list:
                ...
                if lowercase_combination in [x.lower() for x in fictionallist] and chance_roll(
                    insanitylevel, "uncommon"
                ):
                    prompt = prompt.replace(combination, " -fictional- ")

                if lowercase_combination in [x.lower() for x in nonfictionallist] and chance_roll(
                    insanitylevel, "uncommon"
                ):
                ...
                if lowercase_combination in [x.lower() for x in buildinglist] and chance_roll(
                    insanitylevel, "uncommon"
                ):
                ...
                if lowercase_combination in [x.lower() for x in locationlist] and chance_roll(
                    insanitylevel, "uncommon"
                ):
                    prompt = prompt.replace(combination, " -location- ")

                if lowercase_combination in [x.lower() for x in accessorielist] and chance_roll(
                    insanitylevel, "uncommon"
                ):
                    prompt = prompt.replace(combination, " -accessorie- ")

                if lowercase_combination in [x.lower() for x in artmovementlist] and chance_roll(
                    insanitylevel, "uncommon"
                ):
                    prompt = prompt.replace(combination, " -artmovement- ")

                if lowercase_combination in [x.lower() for x in bodytypelist] and chance_roll(
                    insanitylevel, "uncommon"
                ):
                ...
                if lowercase_combination in [x.lower() for x in colorschemelist] and chance_roll(
                    insanitylevel, "uncommon"
                ):
                ...
                if lowercase_combination in [x.lower() for x in descriptorlist] and chance_roll(
                    insanitylevel, "uncommon"
                ):
                    prompt = prompt.replace(combination, " -descriptor- ")

                if lowercase_combination in [x.lower() for x in directionlist] and chance_roll(
                    insanitylevel, "uncommon"
                ):
                ...
                if lowercase_combination in [x.lower() for x in greatworklist] and chance_roll(
                    insanitylevel, "uncommon"
                ):
                    prompt = prompt.replace(combination, " -greatwork- ")

                if lowercase_combination in [x.lower() for x in haircolorlist] and chance_roll(
                    insanitylevel, "uncommon"
                ):
                    prompt = prompt.replace(combination, " -haircolor- ")

                if lowercase_combination in [x.lower() for x in hairstylelist] and chance_roll(
                    insanitylevel, "uncommon"
                ):
                ...
                if lowercase_combination in [x.lower() for x in humanoidlist] and chance_roll(
                    insanitylevel, "uncommon"
                ):
                ...
                if lowercase_combination in [x.lower() for x in lightinglist] and chance_roll(
                    insanitylevel, "uncommon"
                ):
                    prompt = prompt.replace(combination, " -lighting- ")
                if lowercase_combination in [x.lower() for x in malefemalelist] and chance_roll(
                    insanitylevel, "uncommon"
                ):
                    prompt = prompt.replace(combination, " -malefemale- ")
                if lowercase_combination in [x.lower() for x in manwomanlist] and chance_roll(
                    insanitylevel, "uncommon"
                ):
                ...
                if lowercase_combination in [x.lower() for x in othertypelist] and chance_roll(
                    insanitylevel, "uncommon"
                ):
                ...
                if lowercase_combination in [x.lower() for x in shotsizelist] and chance_roll(
                    insanitylevel, "uncommon"
                ):
                    prompt = prompt.replace(combination, " -shotsize- ")
                if lowercase_combination in [x.lower() for x in timeperiodlist] and chance_roll(
                    insanitylevel, "uncommon"
                ):
                ...
                if lowercase_combination in [x.lower() for x in genderdescriptionlist] and chance_roll(
                    insanitylevel, "uncommon"
                ):
                    prompt = prompt.replace(combination, " -genderdescription- ")
                if lowercase_combination in [x.lower() for x in minilocationlist] and chance_roll(
                    insanitylevel, "uncommon"
                ):
                    prompt = prompt.replace(combination, " -minilocation- ")
                if lowercase_combination in [x.lower() for x in minioutfitlist] and chance_roll(
                    insanitylevel, "uncommon"
                ):
                ...
                if lowercase_combination in [x.lower() for x in imagetypequalitylist] and chance_roll(
                    insanitylevel, "uncommon"
                ):
                    prompt = prompt.replace(combination, " -imagetypequality- ")
                if lowercase_combination in [x.lower() for x in rpgclasslist] and chance_roll(
                    insanitylevel, "uncommon"
                ):
                ...
                if lowercase_combination in [x.lower() for x in poemlinelist] and chance_roll(
                    insanitylevel, "uncommon"
                ):
                    prompt = prompt.replace(combination, " -poemline- ")
                if lowercase_combination in [x.lower() for x in songlinelist] and chance_roll(
                    insanitylevel, "uncommon"
                ):
                    prompt = prompt.replace(combination, " -songline- ")
                if lowercase_combination in [x.lower() for x in musicgenrelist] and chance_roll(
                    insanitylevel, "uncommon"
                ):
                    prompt = prompt.replace(combination, " -musicgenre- ")
                if lowercase_combination in [x.lower() for x in manwomanrelationlist] and chance_roll(
                    insanitylevel, "uncommon"
                ):
                    prompt = prompt.replace(combination, " -manwomanrelation- ")
                if lowercase_combination in [x.lower() for x in waterlocationlist] and chance_roll(
                    insanitylevel, "uncommon"
                ):
                    prompt = prompt.replace(combination, " -waterlocation- ")
                if lowercase_combination in [x.lower() for x in containerlist] and chance_roll(
                    insanitylevel, "uncommon"
                ):
                    prompt = prompt.replace(combination, " -container- ")
                if lowercase_combination in [x.lower() for x in firstnamelist] and chance_roll(
                    insanitylevel, "uncommon"
                ):
                ...
                if lowercase_combination in [x.lower() for x in fantasyartistlist] and chance_roll(
                    insanitylevel, "uncommon"
                ):
                    prompt = prompt.replace(combination, " -artistfantasy- ")
                if lowercase_combination in [x.lower() for x in popularartistlist] and chance_roll(
                    insanitylevel, "uncommon"
                ):
                    prompt = prompt.replace(combination, " -artistpopular- ")
                if lowercase_combination in [x.lower() for x in romanticismartistlist] and chance_roll(
                    insanitylevel, "uncommon"
                ):
                    prompt = prompt.replace(combination, " -artistromanticism- ")
                if lowercase_combination in [x.lower() for x in photographyartistlist] and chance_roll(
                    insanitylevel, "uncommon"
                ):
                    prompt = prompt.replace(combination, " -artistphotography- ")

                if lowercase_combination in [x.lower() for x in stylestiloralist] and chance_roll(
                    insanitylevel, "uncommon"
                ):
